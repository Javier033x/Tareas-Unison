...
\begin{enumerate}
    ...
    \begin{enumerate}[(a)]
        ...
        $\frac{T_{CA}}{T_{CB}} = \frac{1{.}5}{1{.}1}$ \\
        $f_A = \frac{1}{1{.}5}= 0{.}6$ \\
        $f_B= \frac{1}{1{.}1}= 0{.}9$ \\
        $\frac{f_A}{f_B}=\frac{0{.}6}{0{.}9} \approx 0{.}6666$
        ...
        $T_C = 0{.}66$ s \\
        $SpeedUP_{C/A} = \frac{1{.}1}{0{.}66} = 1{.}67$ \\
        $SpeedUP_{C/B} = \frac{1{.}5}{0{.}66} = 2{.}27$
        }
    \end{enumerate}
